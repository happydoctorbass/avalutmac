...
export default function HorizontalPromo() {
  const data = LIVEGAME_PROMO_DATA;
  const orientation: "horizontal" | "vertical" = "horizontal";
  
  return (
    <PromoScreen
      imageSrc={`/images/promo/livegame_${orientation}.png`}
      ...
      hook={data.hook}
      rewards={[
        <div key="1" className="flex flex-col gap-1 items-start text-left">
        ...
        <div key="2" className="flex flex-col gap-1 items-start text-left">
        ...
        <div key="3" className="flex flex-col gap-1 items-start text-left">
        ...
        <div key="4" className="flex flex-col gap-1 items-start text-left">
